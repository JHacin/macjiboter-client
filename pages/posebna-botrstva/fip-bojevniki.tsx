            ...
            content={
              <VStack spacing={4}>
                ...
                <Text>
                  ...
                  noben muc ni bolan, saj želimo vsem našim muckom v prihodnje omogočiti
                  zdravljenje.
                </Text>
                <Text>
...

              {
                ...
                content: (
                  <>
                    ...
                    botre mucka Čombeta za dve leti. Prejemali boste vse, kar prejemajo redni mačji
                    botri (pisma muckov, voščila, mesečna ozadja za namizje, in še kaj)
                  </>
                ),
              },
              {
          ...
          <SpecialGroupSubtypeCards
            items={[
              ...
              },
              {
                ...
                description: (
                  <>
                    Z donacijo <FormattedAmount type={SpecialSponsorshipType.FipBojevnikZa1Teden} />{" "}
