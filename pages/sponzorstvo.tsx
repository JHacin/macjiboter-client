      ...
      <Container>
        <Box maxWidth={breakpoints.xl} mx="auto">
          <Section spacing={{ bottom: "none" }}>
            <FilledPageTitle>sponzorstvo</FilledPageTitle>
          </Section>
          ...
          <Section spacing={{ top: "sm" }}>
            <VStack spacing={6} fontSize="lg" maxWidth="850px">
              <Text>
                <strong>
                  Tukaj bodo navedeni podatki glede tega, kako lahko sponzoriraš projekt in (če je
                  relevantno) kaj s tem pridobiš.
                </strong>
              </Text>
              <Text>
